...
<style>
:root{--bg:#f5f5f0;--surface:#ffffff;--border:#e5e5e0;--border2:#d0d0c8;--text:#1a1a18;--text2:#666660;--text3:#999990;--green:#1D9E75;--green-bg:#E1F5EE;--green-text:#0F6E56;--bright-green:#00C851;--bright-green-bg:#E0FFF0;--blue:#185FA5;--blue-bg:#E6F1FB;--blue-text:#0C447C;--amber:#BA7517;--amber-bg:#FAEEDA;--amber-text:#854F0B;--orange:#D4620A;--orange-bg:#FDE8D8;--orange-text:#A04000;--red:#A32D2D;--red-bg:#FCEBEB;--red-text:#791F1F;--radius:14px}
@media(prefers-color-scheme:dark){:root{--bg:#141412;--surface:#1e1e1c;--border:#2e2e2a;--border2:#3a3a36;--text:#f0f0ec;--text2:#aaaaaa;--text3:#666660;--green-bg:#0a2e20;--green-text:#5DCAA5;--bright-green-bg:#003318;--blue-bg:#0a1e35;--blue-text:#85B7EB;--amber-bg:#2e1e00;--amber-text:#EF9F27;--orange-bg:#2e1200;--orange-text:#F08040;--red-bg:#2e0a0a;--red-text:#F09595}}
    ...
    <div class="grid2">
      ...
      <div class="qc" id="qc-sleep">
        <div class="qc-top">
          ...
          <button class="log-btn" onclick="openSheet('sleep')"><i class="ti ti-plus" style="font-size:11px"></i> log</button>
        </div>
      ...
      <div class="qc" id="qc-steps">
        <div class="qc-top">
          ...
          <button class="log-btn" onclick="openSheet('steps')"><i class="ti ti-plus" style="font-size:11px"></i> log</button>
        </div>
      ...
      <div class="qc" id="qc-spend">
        <div class="qc-top">
          ...
          <button class="log-btn" onclick="openSheet('spend')"><i class="ti ti-plus" style="font-size:11px"></i> log</button>
        </div>
